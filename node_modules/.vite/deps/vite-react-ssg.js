import {
  require_jsx_runtime
} from "./chunk-B37KNRDJ.js";
import {
  RouterProvider,
  createBrowserRouter,
  matchRoutes
} from "./chunk-ATTNVVW6.js";
import {
  require_react_dom
...
// node_modules/vite-react-ssg/dist/index.mjs
...
// node_modules/vite-react-ssg/dist/shared/vite-react-ssg.C1RTs5UA.mjs
...
function render(app, container, renderOptions = {}) {
  ...
  if (useLegacyRender || !isReact18) {
    ...
    import("./client-SXTCCBNV.js").then(({ default: { createRoot } }) => {
...
function hydrate(app, container, renderOptions = {}) {
  ...
  if (useLegacyRender || !isReact18) {
    ...
    import("./client-SXTCCBNV.js").then(({ default: { hydrateRoot } }) => {
      import_react2.default.startTransition(() => {
...
// node_modules/vite-react-ssg/dist/shared/vite-react-ssg.BhGKpaqQ.mjs
...
// node_modules/vite-react-ssg/dist/shared/vite-react-ssg.CoMLbIiW.mjs
var import_jsx_runtime = __toESM(require_jsx_runtime(), 1);
var import_react3 = __toESM(require_react(), 1);
function useIsClient() {
  const [isBrowser, setIsBrowser] = (0, import_react3.useState)(false);
...
function ClientOnly({
  ...
  if (isBrowser) {
    if (typeof children !== "function" && true) {
      throw new Error(
...
Current type: ${(0, import_react3.isValidElement)(children) ? "React element" : typeof children}`
      );
    }
...
function Head(props) {
  return (0, import_jsx_runtime.jsx)(W, { ...props });
}
  ...
  if (isClient) {
    (async () => {
      ...
      const lazeMatches = matchRoutes(
        ...
        window.location,
        BASE_URL
      )?.filter((m2) => m2.route.lazy);
      if (lazeMatches && lazeMatches?.length > 0) {
        await Promise.all(
          lazeMatches.map(async (m2) => {
            const routeModule = await m2.route.lazy();
            Object.assign(m2.route, { ...routeModule, lazy: void 0 });
          })
        );
      }
      ...
      const app = (0, import_jsx_runtime2.jsx)(q, { children: (0, import_jsx_runtime2.jsx)(RouterProvider, { router, future: { v7_startTransition } }) });
...
//# sourceMappingURL=vite-react-ssg.js.map
